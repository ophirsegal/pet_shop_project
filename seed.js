...
const seedDB = async () => {
    ...
    // Seed pet items data
    const petItems = [
        { name: "Dog Toys", price: 20, category: "Toys", petId: savedPets[1]._id, image: "/images/dogtoys.jpg" },
        { name: "Cat Toys", price: 15, category: "Toys", petId: savedPets[0]._id, image: "/images/cattoys.jpg" },
        { name: "Bird Food", price: 10, category: "Food", petId: savedPets[2]._id, image: "/images/birdfood.jpg" },
        { name: "Rabbit Food", price: 15, category: "Food", petId: savedPets[3]._id, image: "/images/rabbitfood.jpg" },
        { name: "Dog Food", price: 25, category: "Food", petId: savedPets[1]._id, image: "/images/dogfood.jpg" },
        { name: "Cat Food", price: 30, category: "Food", petId: savedPets[0]._id, image: "/images/catfood.jpg" }
    ];
